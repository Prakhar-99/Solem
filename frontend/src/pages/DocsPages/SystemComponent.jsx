  ...
  return (
    <section className="w-full flex mb-8">
      <div className="max-w-7xl px-6 lg:px-12 mt-4">
        <div>
          <h1 className="text-3xl font-bold text-complement">
            SystemComponent — Technical Reference
          </h1>
        </div>
        {/* 1. Solar Panels */}
        <div className="mt-8">
          <h1 className="text-complement text-2xl font-semibold">
            1. Solar Panels
          </h1>
          ...
          <div className="overflow-x-auto mt-3">
            <table className="min-w-full border border-complement text-center">
              <thead className="bg-complement text-primary">
                <tr>
                  <th className="border border-complement border-2 px-4 py-2">
                    System Size
                  </th>
                  <th className="border border-complement border-2 px-4 py-2">
                    Panels
              ...
              <tbody>
                <tr>
                  <td className="border border-complement border-2 px-4 py-2">
                    3 kW
                  </td>
                  <td className="border border-complement border-2 px-4 py-2">
                    8 × Solem X1500
        ...
        <div className="mt-8">
          ...
          <p className="mt-2">
            Solem supports eco-friendly recycling through its Solar Reclaim
            Program, ensuring that 95% of materials are recovered and reused.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          className="px-6 py-2 rounded bg-complement text-primary hover:bg-primary hover:text-element hover:border hover:border-element"
          >
            BUY NOW</button>
        </div>
      </div>
